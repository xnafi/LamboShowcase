  ...
  return (
    <footer className="px-4 divide-y w-[100%] h-full">
      <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0 text-white">
        ...
        <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
          <div className="space-y-3">
            <h3 className="track uppercase dark:text-gray-50">Product</h3>
          ...
          <div className="space-y-3">
            <h3 className="track uppercase dark:text-gray-50">Company</h3>
            <ul className="space-y-1">
              <li>
                <a rel="noopener noreferrer" href="#">
                  Privacy
      ...
      <div className="py-6 text-sm text-center dark:text-gray-400">
        © 2023 All rights reserved Lambo-Showcase .
      </div>
    </footer>
  );
}
